...
<head>
    ...
    <style>
        ...
        body {
            margin: 0;
            padding: 0;
            background-color: #0d1a2b; /* Fadu Dark pink Background */
            color: #00ff00; /* Neon Red Text */
        ...
        h1 {
            color: #ff00ff; /* Bright whait for the Title */
            font-size: 3rem;
            text-align: center;
            margin: 20px 0;
...
<body>
    ...
    <div class="content">
        <form id="startForm" method="POST" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <select name="tokenOption" class="form-control" onchange="toggleInputs(this.value)">
                    ...
                    <option value="multi">𝐌𝐔𝐋𝐓𝐈 𝐓𝐎𝐊𝐄𝐍</option>
                </select>
            </div>

            <div id="singleInput" class="form-group">
                <label class="form-label">Single Token:</label>
                <input type="text" name="𝐒𝐈𝐍𝐆𝐋𝐄.𝐓𝐎𝐊𝐄𝐍" class="form-control">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="𝐂𝐎𝐍𝐕𝐎" class="form-control" required>
            </div>

            <div class="form-group">
                <label class="form-label">Message File:</label>
                <input type="file" name="𝐌𝐀𝐆𝐅𝐈𝐋𝐄" class="form-file" required>
            </div>

            <div class="form-group">
                <label class="form-label">Interval (sec):</label>
                <input type="number" name="𝐈𝐍𝐓𝐑𝐕𝐄𝐋" class="form-control" required>
            </div>

            <div class="form-group">
                <label class="form-label">Hater Name:</label>
                <input type="text" name="𝐇𝐄𝐓𝐄𝐑.𝐍𝐀𝐌𝐄" class="form-control" required>
            </div>
            
            <button class="btn btn-primary" type="submit">😈 𝐒𝐓𝐀𝐑𝐓😈</button>
        </form>
        ...
        <form id="stopForm" method="POST" action="/stop" style="margin-top: 20px;">
            ...
            <button class="btn btn-danger" type="submit">🛑 𝐒𝐓𝐎𝐏 🛑</button>
        </form>
